...
CREATE TABLE IF NOT EXISTS `entry_pn_tbl` (
  `c_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `c_entry_id` int(11) NOT NULL COMMENT '入库单ID',
  `c_ref_id` int(11) NOT NULL COMMENT '订单品目表ID order_pn_tbl::c_id',
  `c_type` int(11) NOT NULL DEFAULT '0' COMMENT '半成品(0) 成品(1)',
  `c_num` float NOT NULL DEFAULT '0' COMMENT '数量',
  PRIMARY KEY (`c_id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='入库单表PN';

-- テーブル pdsys.entry_pn_tbl: ~2 rows (約) のデータをダンプしています
DELETE FROM `entry_pn_tbl`;
/*!40000 ALTER TABLE `entry_pn_tbl` DISABLE KEYS */;
INSERT INTO `entry_pn_tbl` (`c_id`, `c_entry_id`, `c_ref_id`, `c_type`, `c_num`) VALUES
	(4, 19, 4, 0, 1999);
...
CREATE TABLE IF NOT EXISTS `entry_tbl` (
  ...
  PRIMARY KEY (`c_id`),
  KEY `c_id` (`c_id`)
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8 COMMENT='出库单表';

-- テーブル pdsys.entry_tbl: ~18 rows (約) のデータをダンプしています
DELETE FROM `entry_tbl`;
/*!40000 ALTER TABLE `entry_tbl` DISABLE KEYS */;
INSERT INTO `entry_tbl` (`c_id`, `c_user_id`, `c_entry_time`, `c_update_time`, `c_update_user_id`) VALUES
	(1, 1, '2018-04-06 11:22:56', '2018-04-06 12:23:16', 2),
	(2, 0, NULL, '2018-04-06 12:04:42', NULL),
	(3, 0, NULL, '2018-04-06 12:08:59', NULL),
	(4, 0, NULL, '2018-04-06 12:10:00', NULL),
	(5, 0, NULL, '2018-04-06 12:11:16', NULL),
	(6, 0, NULL, '2018-04-06 12:16:15', NULL),
	(7, 0, NULL, '2018-04-06 12:18:31', NULL),
	(8, 0, NULL, '2018-04-06 12:43:19', NULL),
	(9, 0, NULL, '2018-04-06 12:45:38', NULL),
	(10, 0, NULL, '2018-04-06 12:45:49', NULL),
	(11, 0, NULL, '2018-04-06 12:47:18', NULL),
	(12, 0, NULL, '2018-04-06 12:47:29', NULL),
	(13, 0, NULL, '2018-04-06 12:47:33', NULL),
	(14, 0, NULL, '2018-04-06 12:47:53', NULL),
	(15, NULL, NULL, '2018-04-06 13:14:07', NULL),
	(16, 2, NULL, '2018-04-06 13:27:31', NULL),
	(17, 1, NULL, '2018-04-06 13:27:43', NULL),
	(18, 1, NULL, '2018-04-06 16:12:35', NULL),
	(19, 1, NULL, '2018-04-06 16:36:32', NULL);
